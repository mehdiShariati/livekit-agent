...
# Use the official Python base image with Python 3.13 on Debian Bookworm
...
RUN python livekit_basic_agent.py download-files

# Run the application using Python
# The "start" command tells the worker to connect to LiveKit and begin waiting for jobs.
CMD ["python", "livekit_basic_agent.py", "start"]
