...
python livekit_basic_agent.py download-files

# Download model files for MCP agent
python livekit_mcp_agent.py download-files
```
...
# Production mode
python livekit_basic_agent.py start
```
...
pip install livekit-plugins-cartesia livekit-plugins-elevenlabs

# Additional LLM providers
pip install livekit-plugins-anthropic livekit-plugins-google livekit-plugins-groq

# Additional STT providers
pip install livekit-plugins-assemblyai livekit-plugins-azure
```
